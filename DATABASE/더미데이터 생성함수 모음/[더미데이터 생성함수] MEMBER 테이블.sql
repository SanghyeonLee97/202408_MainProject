...
BEGIN
    ...
    DECLARE korean_first_names VARCHAR(255) DEFAULT '민수,지우,서현,지민,하준,서준,예은,지호,수현,유진,하윤,준서,도윤,예린,윤서';
    ...
    WHILE i <= 100 DO
        ...
        -- 생년월일을 YYMMDD 형식으로 생성 (1970년부터 2010년 사이)
        SET @year = LPAD(FLOOR(70 + (RAND() * 41)), 2, '0');  -- 1970~2010년의 두 자리 연도
